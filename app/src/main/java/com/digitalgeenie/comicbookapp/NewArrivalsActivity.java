...
import com.digitalgeenie.comicbookapp.adapters.NewArrivalsAdapter;
...
public class NewArrivalsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newArrivalsAdapter = new NewArrivalsAdapter(this, itemList);

        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(this, 2);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.addItemDecoration(new NewArrivalsActivity.GridSpacingItemDecoration(2, dpToPx(), true));
    ...
    private void prepareView() {
        ...
        databaseReference.child("comics").limitToLast(5).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot comicsSnapshot : dataSnapshot.getChildren()) {
                    ...
                    itemList.add(new NewArrivalsModel(title, price, thumbnail));
                }
